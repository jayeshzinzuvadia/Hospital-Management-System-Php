...
$doctor = DoctorJob::getInstance()->getDoctor($d_email);
...
if (isset($_POST['save'])) {
    ...
    DoctorJob::getInstance()->updateDoctor($d_email,$address,$phoneno,'img');
            ...
            <div class="row"><!--div4-->
                <div class="col-sm-3"><!--left col-->
                    ...
                    <div class="ml-2 col-sm-6">
                        <input type="file" name="img" class="file" id="img" accept="image/*" onchange="myFunction()">
                    </div>            
                </div>
                <div class="col-sm-9">  
                        ...
                        <div class="tab-pane active" id="home">                  
                            <div class="row">
                                <div class="col-8" style="padding:0">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" 
                                           value="<?php echo $r->getName(); ?>" readonly title="Enter your first name">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-8" style="padding:0">
                                    ...
                                    <input type="text" class="form-control" readonly name="gender" value="<?php echo $r->getGender(); ?>" id="gender">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-8" style="padding:0">
                                    ...
                                    <input type="text" readonly class="form-control" name="birthdate"
                            ...
                            <div class="row">  
                                <div class="col-8" style="padding:0">
                                    ...
                                    <input type="text" class="form-control" name="phoneno" id="phoneno" value="<?php echo $r->getPhno(); ?>" title="enter your mobile number if any.">
                                </div>
                            </div>
